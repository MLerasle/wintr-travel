          ...
          <div className="flex justify-center items-center">
            <div className="max-w-md mx-8 sm:mx-auto py-10 helmet-description">
              <GridArg title="Casque ski Bollé Backline Visor Premium">
                ...
                rembourrage en tissu hypoallergénique, un système Click to Fit
                et une visière rotative en polycarbonate avec vue panoramique
                pour profiter pleinement de votre séjour en toute sécurité.
              </GridArg>
            </div>
          </div>
