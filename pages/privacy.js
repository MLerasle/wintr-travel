          ...
          <div className="relative pb-16 px-4 sm:px-6 lg:px-8">
            <div className="text-lg max-w-prose mx-auto prose prose-blue md:prose-lg text-gray-500">
              ...
              <p>
                ...
                européen 2016/679, la collecte et le traitement des données des
                utilisateurs du site respectent les principes suivants :
              </p>
              <ul>
                <li>
                  Licéité, loyauté et transparence : les données ne peuvent être
                  collectées et traitées qu'avec le consentement de
                ...
                <li>
                  ...
                  informé. Lorsque cette information ne peut pas être
                  communiquée, l'utilisateur est informé des critères utilisés
              ...
              <p>
                ...
                dans les systèmes informatiques de l'éditeur du site une preuve
                de la transaction comprenant le bon de commande et la facture.
              </p>
              <p>
              ...
              <p>
                Le site Wintr Travel est hébergé par : Vercel Inc., dont le
              ...
              <h2>
                ARTICLE 4 : RESPONSABLE DU TRAITEMENT DES DONNÉES ET DÉLÉGUÉ À
                LA PROTECTION DES DONNÉES
              </h2>
              <h3>A. LE RESPONSABLE DU TRAITEMENT DES DONNÉES</h3>
              <p>
                Le responsable du traitement des données à caractère personnel
                est : Adrien Naeem. Il peut être contacté de la manière suivante
                :
              </p>
              <p className="italic">
              ...
              <p>
                Par ailleurs, l'utilisateur est informé que la personne suivante
                a été nommée Délégué à la Protection des Données :{' '}
                <span className="italic">Adrien Naeem</span>.
              </p>
              <p>
                Le rôle du Délégué à la Protection des Données et de s'assurer
                la bonne mise en oeuvre des dispositions nationales et
              ...
              <h3>
                A. PRÉSENTATION DES DROITS DE L'UTILISATEUR EN MATIÈRE DE
              ...
              <p>
                ...
                site ne puisse refuser, sauf à démontrer 5/9 l'existence de
                motifs légitimes et impérieux, pouvant prévaloir sur les
                intérêts et les droits et libertés de l'utilisateur.
              </p>
              <p>
              ...
              <p>
                ...
                une durée de 13 (treize) mois maximum. A l'issue de cette
                période, le site demandera à nouveau l'autorisation de
                l'utilisateur pour enregistrer des fichiers "cookies" sur son
                disque dur.
              </p>
              <h3>
              ...
              <p>
                L'éditeur du site attire l'attention de l'utilisateur sur le
                fait que les cookies suivants sont utilisés lors de sa
                navigation :
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                Des fichiers "cookies" de ces réseaux sociaux sont par
                conséquent susceptibles d'être stockés sur l'ordinateur de
                l'utilisateur lorsqu'il utilise ces fonctionnalités.
              </p>
              <p>
                L'attention de l'utilisateur est portée sur le fait que ces
                sites disposent de politiques de confidentialité propres et de
              ...
              <p>
                ...
                compris la présente politique de confidentialité et en accepte
                les conditions, en ce qui concerne plus particulièrement la
