            ...
            <dl className="space-y-6 divide-y divide-gray-200">
              <Question query="Où en est ma commande ?">
                <p className="text-base text-gray-500 py-1">
                  Nous travaillons avec notre propre transporteur pour nous
                  assurer de la livraison dans les meilleures conditions.
                </p>
                <p className="text-base text-gray-500 py-1">
                  L’équipe de Wintr Travel prendra contact avec vous quelques
                  jours avant votre arrivée si des informations sont manquantes.
                </p>
                <p className="text-base text-gray-500 py-1">
                  Vous pouvez nous contacter à tout moment, nous sommes
                  disponibles à toute heure pour vous répondre.
                </p>
              </Question>
              <Question query="Je me suis trompé(e) d’adresse ou de taille lors de ma commande, que faire ?">
                ...
                <p className="text-base text-gray-500 py-1">
                  ...
                  confirmation de votre commande et effectuez directement en
                  ligne les modifications souhaitées.
                </p>
                <p className="text-base text-gray-500 py-1">
              ...
              <Question query="Comment vous contacter ?">
                <p className="text-base text-gray-500 py-1">
                  ...
                  ou nous laisser un message dans le chat, nous répondrons au
                  plus vite.
                </p>
              </Question>
              <Question query="Quels sont les coûts et délais de livraison ?">
                <p className="text-base text-gray-500 py-1">
                  ...
                  engageons à vous livrer au mieux dans le créneau défini lors
                  de la commande.
                </p>
                <p className="text-base text-gray-500 py-1">
                  Si vous avez des retards ou souhaitez modifier le créneau,
                  c’est simple il suffit de nous contacter.
                </p>
              </Question>
              ...
              <Question query="Puis-je annuler ma commande ?">
                ...
                <p className="text-base text-gray-500 py-1">
                  Sachez que vous pouvez annuler votre commande sans frais
                  jusqu'à 24 heures avant votre arrivée.
                </p>
                <p className="text-base text-gray-500 py-1">
                  Vous serez intégralement remboursés dans un délai de 48
                  heures.
                </p>
              </Question>
            </dl>
