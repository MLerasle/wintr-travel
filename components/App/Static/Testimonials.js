...
const Testimonials = () => (
  <section className="bg-gray-50">
    <h2 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl py-6 sm:py-10">
    ...
    <div className="max-w-7xl mx-auto md:grid md:grid-cols-3 md:px-6 lg:px-8">
      ...
      <div className="py-12 px-4 border-t md:flex md:flex-col border-gray-200 sm:px-6 md:py-16 md:pl-0 md:pr-10 md:border-t-0 md:border-l lg:pl-16">
      ...
      <div className="py-12 px-4 border-t md:flex md:flex-col border-gray-200 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
